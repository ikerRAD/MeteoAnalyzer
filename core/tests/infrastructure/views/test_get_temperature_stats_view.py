...
class TestIntegrationGetTemperatureStatsView(TestCase):
    @classmethod
    ...
    def test_get(self) -> None:
        ...
        self.maxDiff = None
        self.assertEqual("/stats/temperature/", url)
            ...
            [
                {
                    ...
                    "temperature": {
                        "average": 5.0,
                        "average_by_day": {"2011-01-02": 5.0},
                        "max": {"value": 10.0, "date": "2011-01-02T01:00"},
                        "min": {"value": 0.0, "date": "2011-01-02T00:00"},
                ...
                },
                {
                    ...
                    "temperature": {
                        "average": 10.0,
                        "average_by_day": {"2010-02-02": 5.0, "2011-02-02": 20.0},
                        "max": {"value": 20.0, "date": "2011-02-02T01:00"},
                        "min": {"value": 5.0, "date": "2010-02-02T00:00"},
                        "hours_above_threshold": 0,
                        "hours_below_threshold": 0,
                    },
                },
